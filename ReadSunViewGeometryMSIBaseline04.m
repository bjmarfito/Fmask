function [MSIinfo Angles CM]  = ReadSunViewGeometryMSIBaseline04 (DataStrip,Granule,BandSel,PsizeOut,Dmain)
...
for iB = 1:length(BandList)
  ...
  DetectFootPrint.Ndect =  unique(Matdetec(Matdetec> 0));
  DetectFootPrint.Nband =  ones(size(DetectFootPrint.Ndect));
